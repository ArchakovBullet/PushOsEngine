...
namespace OsEngine.Robots
{
	...
	[Bot("ASTrendFIZTrailMode")] // We create an attribute so that we don't write anything to the BotFactory
    public class ASTrendFIZTrailMode : BotPanel
    {
        ...
        public ASTrendFIZTrailMode(string name, StartProgram startProgram) : base(name, startProgram)
        {
