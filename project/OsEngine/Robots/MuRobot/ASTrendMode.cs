...
namespace OsEngine.Robots.MuRobot
{
	...
	[Bot("ASTrendMode")] // We create an attribute so that we don't write anything to the BotFactory
    public class ASTrendMode : BotPanel
    {
        ...
        public ASTrendMode(string name, StartProgram startProgram) : base(name, startProgram)
        {
			...
			// Indicator setting
			_lengthFI = CreateParameter("FIZero Length", 26, 7, 48, 7, "Indicator");
